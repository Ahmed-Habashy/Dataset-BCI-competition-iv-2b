...
# ********* replace gray\ to ===== gray\Test for test data
 # make folder for results
makedirs('D:\PhD Ain Shams\Dr Seif\GANs\python_ex\BCI_IV_2b GAN\spectrogram_adv\gray\Test\sub_{}\CL1'.format(subject), exist_ok=True) 
makedirs('D:\PhD Ain Shams\Dr Seif\GANs\python_ex\BCI_IV_2b GAN\spectrogram_adv\gray\Test\sub_{}\CL2'.format(subject), exist_ok=True) 
makedirs('D:\PhD Ain Shams\Dr Seif\GANs\python_ex\BCI_IV_2b GAN\spectrogram_adv\gray\Test\CL1_3ch', exist_ok=True) 
makedirs('D:\PhD Ain Shams\Dr Seif\GANs\python_ex\BCI_IV_2b GAN\spectrogram_adv\gray\Test\CL2_3ch', exist_ok=True) 
    ...
    for i in range(num_trials):
        for j in range(3):   
            ...
            if draw==True:
                ...
                # plt.xlabel('Time [sec]')
                plt.savefig('D:\PhD Ain Shams\Dr Seif\GANs\python_ex\BCI_IV_2b GAN\spectrogram_adv\gray\Test\CL{0}_3ch\cl{0} STFT_{3}_ch {1}_t{2} .png'.format(cl ,j, i, subject), bbox_inches= 'tight', pad_inches= 0)
                plt.show() 
        img26 = Image.open('D:\PhD Ain Shams\Dr Seif\GANs\python_ex\BCI_IV_2b GAN\spectrogram_adv\gray\Test\CL{0}_3ch\cl{0} STFT_{2}_ch 0_t{1} .png' .format(cl , i, subject)) # Path to image
        img28 = Image.open('D:\PhD Ain Shams\Dr Seif\GANs\python_ex\BCI_IV_2b GAN\spectrogram_adv\gray\Test\CL{0}_3ch\cl{0} STFT_{2}_ch 1_t{1} .png' .format(cl , i, subject)) # Path to image
        img30 = Image.open('D:\PhD Ain Shams\Dr Seif\GANs\python_ex\BCI_IV_2b GAN\spectrogram_adv\gray\Test\CL{0}_3ch\cl{0} STFT_{2}_ch 2_t{1} .png' .format(cl , i, subject)) # Path to image
        get_concat_v(img26, img28, img30).save('D:\PhD Ain Shams\Dr Seif\GANs\python_ex\BCI_IV_2b GAN\spectrogram_adv\gray\Test\sub_{2}\CL{0}\cl{0} ch3_{2}_tr{1}.bmp' .format(cl , i, subject)) 
